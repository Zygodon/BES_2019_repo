# Make bubble plot, Distance from MG5a standard for each assembly,
# x-axis nearest standard community. Assemblies coded by species_count
# (point size) and assessed nvc (colour; lower case)
# This plot used in BES 2019 poster Figure 3.
